...
| 编号 | 页面 | 路由 | 优先级 | 现状 | 人日 |
|---|---|---|---|---|---|
| 1.1 | 大盘概览 | `/analytics` | **P0** | 🟡 仅 59 行 | 8 |
| 1.2 | 每日报表 | `/analytics/daily` | P1 | ❌ | 5 |
| 1.3 | 月度报表 | `/analytics/monthly` | P1 | ❌ | 3 |
| 1.4 | 渠道报表 | `/analytics/channel` | P1 | ❌ | 5 |
| 1.5 | 用户留存 | `/analytics/retention` | P1 | ❌ | 5 |
| 1.6 | 用户流失 | `/analytics/churn` | P1 | ❌ | 3 |
| 1.7 | 活动 ROI | `/analytics/activity-roi` | P1 | ❌ | 5 |
