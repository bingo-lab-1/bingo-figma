...
- 是其余 6 个用户相关页面的跳转枢纽(2.2–2.7 均可从本页进入)
...
**表格列**(共 31 列,默认视口内只显示前几列,其余需横向滚动;支持「列设置」)

| 组 | 列 |
|---|---|
| 身份 | 序号 · 用户ID · 邀请人 · 用户昵称 · **用户标签** · 用户账号 |
| 状态 | 在线状态 · VIP等级 · 测试账号 |
| 联系 | 用户提现绑定手机 |
| 来源 | 渠道来源 |
| 注册 | 注册时间 · 注册IP · 注册设备 · 注册平台 |
| 登录 | 登录时间 · 登录设备 · 登陆平台 |
| 资金 | 首充时间 · 总流水金额 · 总充值金额 · 总提现金额 · **真金余额** · **彩金余额** |
| 活跃 | 最后投注时间 · 最后存款时间 · 最后登录时间 |
| 操作 | 设为测试账号(固定在右侧) |

- **用户ID** 为蓝色可点文本,点击打开详情弹窗;旁边的**复制按钮只复制 ID,不打开弹窗**
- **用户标签列很宽**(单个玩家常挂十几个标签),会把后面的列推出视口
