...
| 表 | 说明 | 现状 |
|---|---|---|
| `Activity` | 活动主表 | 🟡 **待重构为配置化引擎** |
| `ActivityClaim` | 统一领取记录 | ❌ 新增 |
| ~~9 张 `*Config` 表~~ | 一活动一表 | 🔴 **待合并进引擎** |
| `GamePlatform` / `GameType` / `SubGame` | 游戏与厂商 | ✅ |
| `GameHot` | 热门位 | ✅ |
| `Fairness` / `FairnessHistory` | 公平性 | ✅ |
| `BetRecords` | 投注记录 | ✅ |
| `LobbyLayout` | 大厅布局 | ❌ 新增 |
...
| 4.2 | 充值类活动 | `/game/activity/recharge` | **P0** | 🟡 9 个硬编码 | 8 |
| 4.3 | 活动领取记录 | `/game/activity/claim` | **P0** | ❌ | 4 |
| 4.4 | 游戏列表与品牌 | `/game/list` | **P0** | ✅ | 2 |
| 4.5 | 留存类活动 | `/game/activity/retention` | P1 | ❌ | 8 |
| 4.6 | 打码类活动 | `/game/activity/wagering` | P1 | 🟡 | 5 |
| 4.7 | 大厅编排 | `/game/lobby` | P1 | 🟡 仅 `GameHot` | 5 |
| 4.8 | 公平性查询 | `/game/fairness` | P1 | ✅ | 2 |
| 4.9 | VIP 配置 | `/game/vip` | P1 | 🔴 双轨待定 | 8 |
| 4.10 | 任务系统 | `/game/task` | P2 | ❌ | 10 |
| 4.11 | 道具卡配置 | `/game/item-card` | P2 | ❌ | 5 |
...
| `game:activity:edit` | **编辑活动配置** | 4.1-4.2 | ✅ |
| `game:activity:toggle` | **启用/停用活动** | 4.1-4.2 | ✅ |
| `game:claim:view` | 查看领取记录 | 4.3 | — |
| `game:list:view` | 查看游戏列表 | 4.4 | — |
| `game:list:edit` | 编辑游戏/品牌 | 4.4 | — |
| `game:vip:edit` | 编辑 VIP 配置 | 4.9 | ✅ |
