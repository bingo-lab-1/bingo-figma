...
| 有效投注 | 实际投注 × 游戏折算比例(A12);与提现流水、打码、VIP 成长同口径 |
...
| 7.1-R6 | 佣金冲回 | 来源充值冲正/退款 | 未领取的记录直接**作废**;已领取的自动冲回**以钱包余额为上限**(不产生负余额),未耗打码任务核销;差额生成**佣金挂账**(关联原佣金记录)并告警,首版仅记录与人工处理,**不做自动抵债**(模块决策 D27)。投注返佣结算后的注单回滚**不追溯**,超阈值告警 | 系统触发,无界面权限 |
...
- **拥有**(owner=M7):活动配置及修改历史 · 档位表 · 佣金记录 · 结算批次 ·
  佣金挂账(冲回差额,关联原佣金记录;展示与处理入口在 7.2)
